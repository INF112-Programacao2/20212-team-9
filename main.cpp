...
int inicializar_allegro()
{
    ...
    enemy = al_load_bitmap("assets/Inimigo_p.png");
    if(!enemy)
    {
    ...
    //SOM============================
    trilha_sonora = al_load_sample("assets/Trilha_sonora.wav");
    if(!trilha_sonora){
    ...
    //MENU===========================
    menu = al_load_bitmap("assets/Menu_bmp.bmp");
    if(!menu){
    ...
    tela_game_over = al_load_bitmap("assets/GameOver.bmp");
    if(!tela_game_over) {
    ...
    fundo_loja = al_load_bitmap("assets/fundo_loja.bmp");
    if(!fundo_loja) {
    ...
    icone_torre = al_load_bitmap("assets/icone_1.bmp");
    if(!icone_torre) {
    ...
    icone_morteiro = al_load_bitmap("assets/icone_2.bmp");
    if(!icone_morteiro) {
    ...
    tower = al_load_bitmap("assets/tower.bmp");
    if(!tower) {
    ...
    morteiro = al_load_bitmap("assets/morteiro.bmp");
    if(!morteiro) {
    ...
    jogador_HUD = al_load_bitmap("assets/jogador_HUD.bmp");
    if(!jogador_HUD) {
    ...
    vida_jogador = al_load_font("assets/arial.ttf", 36, 0);
    if(!vida_jogador) {
    ...
    ouro_jogador = al_load_font("assets/arial.ttf", 36, 0);
    if(!ouro_jogador) {
    ...
    score_jogador = al_load_font("assets/arial.ttf", 36, 0);
    if(!score_jogador) {
